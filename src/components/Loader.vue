<template>
  <svg width="40px" height="40px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="lds-ellipsis" style="background: none;">
    ...
    <circle cx="84" cy="50" r="0.543861" fill="#f8b26a">
    ...
    <circle cx="82.1509" cy="50" r="10" fill="#f47e60">
    ...
    <circle cx="48.1509" cy="50" r="10" fill="#e15b64">
    ...
    <circle cx="16" cy="50" r="9.45614" fill="#abbd81">
